...
parser.add_argument('--attention_pruning_method', default="disabled", help='attention pruning method', choices=('disabled', 'topK', 'topK:1d_alt', 'threshold', 'sigmoied_threshold:1d_alt'))
